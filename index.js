...
async function connect() {
    // Add MongoDB connection string here. Looks like mongodb+srv://<user>:<password>@name...mongodb.net/test
  await mongoose.connect('INSERT MONGO DB CONNECTION STRING HERE');
}
